...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AMDLaunchSecurity) DeepCopyInto(out *AMDLaunchSecurity) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AMDLaunchSecurity.
func (in *AMDLaunchSecurity) DeepCopy() *AMDLaunchSecurity {
	if in == nil {
		return nil
	}
	out := new(AMDLaunchSecurity)
	in.DeepCopyInto(out)
	return out
}
